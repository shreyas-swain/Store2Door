...
import { KeyboardAvoidingView, StyleSheet, Text, TextInput, TouchableOpacity, View, ScrollView, Image, } from "react-native";
          ...
          <SafeAreaView className="flex">
            <View className="flex-row justify-start">
              ...
              <TouchableOpacity className="mt-2">
                <Text className="pl-5 text-gray-900 rounded-xl ml-20 text-2xl font-bold">Sign Up</Text>
              </TouchableOpacity>
            </View>
          ...
          >
            <View className="form space-y-2">
              ...
              <View>
                ...
                <TextInput
                  className="p-4 bg-gray-100 text-gray-700 rounded-2xl mb-2"
                  placeholder="john_example@gmail.com"
                  onFocus={() => {
                    setEmailfocus(true);
                    setPasswordfocus(false);
                    setShowpassword(false);
              ...
              <View>
                <Text className="text-gray-700 ml-4 mb-2">Phone Number</Text>
                <TextInput
                  className="p-4 bg-gray-100 text-gray-700 rounded-2xl mb-2"
              ...
              <View>
                <Text className="text-gray-700 ml-4 mb-2">Confirm Password</Text>
                <TextInput
                  className="p-4 bg-gray-100 text-gray-700 rounded-2xl mb-2"
                  placeholder="test12345"
                  onFocus={() => {
            ...
            <View className="flex-row justify-center mt-7 mb-20">
